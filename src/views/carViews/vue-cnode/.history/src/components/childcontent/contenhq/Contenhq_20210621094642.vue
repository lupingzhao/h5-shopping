  ...
  methods: {
    ...
    getTimeDifference(a, b) {
      ...
      if (sjcz < 30) {
        ...
        //分钟数
        return `${parseInt(sjcz / 60)}分钟前`;
      } else if (sjcz / 3600 < 24) {
        return `${parseInt(sjcz / 3600)}个小时前`;
      } else if (sjcz / 3600 / 24 < 30) {
        return `${parseInt(sjcz / 3600 / 24)} 天前`;
      } else if (sjcz / 3600 / 24 / 30 < 12) {
        return `${parseInt(sjcz / 3600 / 24 / 30)} 个月前`;
      } else if (sjcz / 3600 / 24 / 30 / 12 >= 1) {
        return `${parseInt(sjcz / 3600 / 24 / 30 / 12)} 年前`;
      }
    },
  },
  ...
  computed: {
    ...
    sjc() {
      return this.list.map((a) => {
        this.creatTime = dayjs(a.last_reply_at).valueOf();
